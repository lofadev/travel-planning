        ...
        [
            SystemMessage(
                content=(
                    ...
                    "duration (số ngày tính toán 1 cách thông minh từ ngày đi đến ngày về, "
                    "ví dụ: '3 ngày 2 đêm'), "
                    "people_count (số người đi, ví dụ: 2 hoặc 4), "
                    "transports (danh sách phương tiện), ví dụ ['tàu hỏa', 'máy bay']"
        ...
        [
            SystemMessage(
                content=(
                    ...
                    "Cấu trúc mỗi ngày với 4 phần chính: lịch trình hoạt động (bao gồm vui chơi giải trí), "
                    "phương tiện di chuyển, gợi ý ăn uống, chi phí ước tính/"
            ...
            HumanMessage(
                content=(
                    ...
                    f"- Phương tiện: {extracted.get('transports', 'tùy chọn')}\n"
